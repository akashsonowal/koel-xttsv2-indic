...
from FastTTS.config.shared_configs import BaseAudioConfig, BaseDatasetConfig, BaseTrainingConfig
from FastTTS.utils.generic_utils import find_module
...
def register_config(model_name: str) -> Coqpit:
    ...
    paths = ["FastTTS.tts.configs", "FastTTS.vocoder.configs", "FastTTS.encoder.configs", "FastTTS.vc.configs"]
    for path in paths:
        try:
