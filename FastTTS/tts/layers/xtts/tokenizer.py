...
from FastTTS.tts.layers.xtts.zh_num2words import TextNorm as zh_num2words
from FastTTS.tts.utils.text.cleaners import collapse_whitespace, lowercase
...
class VoiceBpeTokenizer:
    ...
    def check_input_length(self, txt, lang):
        ...
        limit = self.char_limits.get(lang, 300) # 250
        if len(txt) > limit:
            logger.warning(
